...
public class Config {
    ...
    private static String exchangeName = "exch1";
    public static int numberOfTaskQueues = 4;

//    QUEUES USED BY EXCHANGE CONNECTIVITY
    private static String makeOrderQueue = "queue:te:exch1:makeorder";
    private static String orderBookQueue = "queue:te:exch1:orderbook";
    private static String orderMonitorQueue = "queue:te:exch1:ordermonitor";
